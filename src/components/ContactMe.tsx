...
const ContactMe = () => {
  ...
  return (
    <div className="h-screen flex relative text-col text-center md:text-left md:flex-row max-w-7xl px-10 justify-evenly mx-auto items-center">
      ...
      <div className="flex flex-col space-y-10">
        ...
        <div className="space-y-10">
          ...
          <div className="flex items-center justify-center space-x-5">
            ...
            <p className="text-2xl">ibrahim.hafez99@Hotmail.com</p>
          </div>
          <div className="flex items-center justify-center space-x-5">
