...
const Skill = ({ directionLeft }: Props) => {
  return (
    <div className="group relative flex curosr-pointer">
      <motion.img
        initial={{
      ...
      />
      <div className="absolute opacity-0 group-hover:opacity-60 transition duartion-300 ease-in-out group-hover:bg-white h-24 w-24 md:w-28 md:h-28 xl:w-32 xl:h-32 rounded-full">
